...
void main()
{
    ...
    v_blurTexCoords[ 0] = v_texCoord + vec2(-0.016, 0.0);
    v_blurTexCoords[ 1] = v_texCoord + vec2(-0.012, 0.0);
    v_blurTexCoords[ 2] = v_texCoord + vec2(-0.008, 0.0);
    ...
    v_blurTexCoords[ 6] = v_texCoord + vec2( 0.012, 0.0);
    v_blurTexCoords[ 7] = v_texCoord + vec2( 0.016, 0.0);
