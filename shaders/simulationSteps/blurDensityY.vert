...
void main()
{
    ...
    v_blurTexCoords[ 0] = v_texCoord + vec2(0.0, -0.016);
    v_blurTexCoords[ 1] = v_texCoord + vec2(0.0, -0.012);
    v_blurTexCoords[ 2] = v_texCoord + vec2(0.0, -0.008);
    v_blurTexCoords[ 3] = v_texCoord + vec2(0.0, -0.004);
    v_blurTexCoords[ 4] = v_texCoord + vec2(0.0,  0.004);
    v_blurTexCoords[ 5] = v_texCoord + vec2(0.0,  0.008);
    v_blurTexCoords[ 6] = v_texCoord + vec2(0.0,  0.012);
    v_blurTexCoords[ 7] = v_texCoord + vec2(0.0,  0.016);
